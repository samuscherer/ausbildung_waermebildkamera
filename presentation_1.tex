...
\mode<presentation> {
	...
	\hspace*{15pt}\hbox{\scriptsize Quelle:\thinspace{\itshape Nutzer ``Degreen'', Wikimedia Commons}}}
    \end{frame}
    ...
    \centering{\includegraphics[width=0.6\textwidth, keepaspectratio]{user_interface}\\
	\hspace*{15pt}\hbox{\scriptsize Quelle:\thinspace{\itshape FLIR/Samuel Scherer}}}
    \end{frame}
        ...
        \item<3-> wir lassen sie auf dem LF, wenn offensichtlich
            ...
            \item<2-> Nutzung im Einsatz:
                ...
                \item<3-> Personensuche (Brand/VU/Wasserrettung)
					...
					\hspace*{15pt}\hbox{\scriptsize Quelle:\thinspace{\itshape Samuel Scherer, FLIR}}
                                        \end{itemize}
                                        \end{frame}
